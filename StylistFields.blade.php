...
<div class="form-group">
  <label for="name" class="font-weight-bold">Stylist Name</label>
...
<div class="form-group">
  <label for="history" class="font-weight-bold">history</label>
  <input type="text" class="form-control" id="history" name="history" value="{{old('history')?? $stylist->history}}" >
</div>

<div class="form-group">
  <label for="urlimg" class="font-weight-bold">urlimg</label>
